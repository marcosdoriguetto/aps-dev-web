...
const validateSchema = yup.object().shape({
  name: yup
    .string()
    .required("Por favor insira um nome pro projeto"),
  startDate: yup
    .string()
    .required("Por favor insira a data de início")
    .test('startDate', 'Por favor insira uma data válida', value => value && validateDate(value)),
  finishedDate: yup
    .string()
    .required("Por favor insira a data de finalização")
    .test('finishedDate', 'Por favor insira uma data válida', value => value && validateDate(value)),
});
